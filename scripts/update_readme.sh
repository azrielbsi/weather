...
echo -e "<tr>" >> README.md
echo -e "<td align="center"><b>${city}</b><br><b>${temperature_celsius}°C</b><br><img src='${icon_url}' height='50'><br><b>$condition</b><br><img src="images/thermometer.png" height="18"> Feels Like: ${feels_like_celsius}°C</td>" >> README.md
echo -e "</tr>" >> README.md
echo -e "<td>" >> README.md
