...
visibility_km=$(awk "BEGIN {printf \"%.2f\", $visibility_meter / 1000}")
...
echo -e "<td align='center'><img src='images/low-visibility.png' height='25'><br>Visibility:<br><b>${visibility_km:-N/A} km</b></td>" >> README.md
echo -e "</tr>" >> README.md
echo -e "<tr>" >> README.md
