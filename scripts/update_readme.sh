...
forecast_info=$(curl -s "https://api.openweathermap.org/data/2.5/onecall?lat=44.34&lon=10.99&exclude=current,minutely,hourly&appid=${OPENWEATHERMAP_API_KEY}")
...
echo -e "</tr>" >> README.md
echo -e "<tr>" >> README.md
echo -e "<td align="center" colspan="2">${forecast_info}</td>" >> README.md
echo -e "</tr>" >> README.md
echo -e "</table>" >> README.md
echo -e "</table>" >> README.md
