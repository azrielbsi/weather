...
echo -e "<li>Powered by: <a href="https://github.com/azrielbsi/weather">weather</a></li>" >> README.md
echo -e "<li>© Copyright: <a href="https://github.com/${{ github.repository_owner }}">${{ github.repository_owner }}</a></li>" >> README.md
echo -e "<li><a href="https://github.com/${{ github.repository_owner }}/weather/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-yellow.svg"></a></li>" >> README.md
